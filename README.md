...
The Car Price Predictor is a flask web application which gives a price of a car into viz. The code is written in Python 3.6.10 and makes use of Keras and Tensorflow libraries in developing an InceptionV3 based image regression web application. 
